...
caminho_origem = input('Qual é o caminho dos arquivos?')
caminho_destino = input('Qual é a destino dos arquivos?')
...
for raiz, pastas, arquivos in os.walk(caminho_origem):
    for arquivo in arquivos:
        ...
        comando = f'{comando_ffmpeg} -i "{caminho_completo}" {input_legenda} {codec_video}'\
            f'{crf} {preset} {codec_audio} {bitrate_audio} {debug} {map_legenda} "{arquivo_saida}"'
